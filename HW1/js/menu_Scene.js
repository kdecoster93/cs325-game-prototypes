...
class menu_Scene extends Phaser.Scene {
    ...
    create() {
        ...
        this.titleText = this.add.text(175, config.height / 2 - 200, 'LAUNCH!', { font: '96px Roboto', fill: '#ff0000' });
        this.eText = this.add.text(50, (config.height / 2), 'Press E to Play!', { font: '32px Roboto', fill: '#ffffff' });
        this.controlsText1 = this.add.text(50, (config.height / 2) + 50, 'Movement: WASD', { font: '32px Roboto', fill: '#ffffff' });
        this.controlsText2 = this.add.text(50, (config.height / 2) + 100, 'To Fire: Right/Left Click', { font: '32px Roboto', fill: '#ffffff' });
        this.controlsText3 = this.add.text(50, (config.height / 2) + 150, 'Accelerate: Hold down SHIFT', { font: '32px Roboto', fill: '#ffffff' });
        this.goalText = this.add.text(50, (config.height / 2) + 200, 'Goal: Hold down shift long enough to reach your \nmaximum velocity and leave the planet!', { font: '32px Roboto', fill: '#ffffff' });
