...
class play_Scene01 extends Phaser.Scene {
    ...
    create() {
		...
		this.physics.world.setBounds(0,-500, 8000, 1800);
		...
		this.buildings.create(7200, 50, 'building05').setScale(6);
		this.buildings.create(8000, 50, 'building01').setScale(6);
		...
		*/
		...
		// Next Level Entrance
		this.obstacles.create(6495, 525, 'ground').setScale(3).refreshBody();
		this.obstacles.create(6780, 525, 'ground').setScale(3).refreshBody();
		this.obstacles.create(6780, 429, 'ground').setScale(3).refreshBody();
		this.obstacles.create(7065, 525, 'ground').setScale(3).refreshBody();
		this.obstacles.create(7065, 429, 'ground').setScale(3).refreshBody();
		this.obstacles.create(7065, 333, 'ground').setScale(3).refreshBody();
		this.obstacles.create(7065, 237, 'ground').setScale(3).refreshBody();
		...
		*/
		...
		this.alex = this.physics.add.sprite(400, 300, 'alex');
		...
		*/
		...
		this.effects.create(1000, 425, 'fire').setScale(3).setSize(64, 128).setOffset(0, 80).anims.play('fire_anim', true);
		this.effects.create(1570, 333, 'fire').setScale(3).setSize(64, 128).setOffset(0, 80).anims.play('fire_anim', true);
		this.effects.create(2485, 137, 'fire').setScale(3).setSize(64, 128).setOffset(0, 80).anims.play('fire_anim', true);
		this.effects.create(2885, 137, 'fire').setScale(3).setSize(64, 128).setOffset(0, 80).anims.play('fire_anim', true);
		this.effects.create(3600, 237, 'fire').setScale(3).setSize(64, 128).setOffset(0, 80).anims.play('fire_anim', true);
		this.effects.create(4170, 137, 'fire').setScale(3).setSize(64, 128).setOffset(0, 80).anims.play('fire_anim', true);
		...
		*/
		...
		this.physics.add.overlap(this.alex, this.demon, this.playerCombatBoss, null, this);
	...
	*/
    ...
    { 
		...
		//var fireExplosion = new Explosion(this, randomX, randomY);
	}
		...
		this.demon.children.iterate(function (child) { 
			...
			*/
			...
			if (Math.abs(player.body.position.x - child.body.position.x) <= 650) {
				...
				if (child.body.position.x < player.body.position.x - 252) {
					child.flipX = true;
				...
				else if (child.body.position.x > player.body.position.x + 44) {
					child.flipX = false;
				...
				else if (child.body.position.x <= player.body.position.x + 44 && child.body.position.x >= player.body.position.x - 252 && child.body.position.y <= player.body.position.y + 320 && child.body.position.y >= player.body.position.y - 320) {
